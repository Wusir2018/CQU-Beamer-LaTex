...
\mode<presentation> {
  \usetheme{Warsaw}   %[hideothersubsections] beamer 这是模板!!!!!!!!
...
%  \usefonttheme{serif} % Times New Rome 字体
  \usecolortheme{default}% default%这个是具体模板下的颜色配置!赞!!!!!!!
...
%\logo{\includegraphics[height=0.1\textwidth]{cqu_logo.pdf}} % 校徽logo

%\pgfdeclareimage[height=5cm]{logo}{cqu_logo.pdf}
%\logo{\pgfuseimage{logo}}

% Background   定义学校背景
\pgfdeclareimage[width=\paperwidth,height=0.95\paperheight]{bg}{cqbackground.png}
