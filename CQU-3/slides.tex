...
\begin{frame}{图片}
    \begin{figure}
        \centering
        \includegraphics[width=0.85\textwidth]{cqu_logo.png}
...
\begin{frame}{分栏}
    \begin{columns}
        \begin{column}{0.3\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.95\textwidth]{cqu_logo.png}
...
\begin{frame}{Subfigure}
    \begin{figure}
        \centering
        \subfigure[]{\includegraphics[width=0.47\textwidth]{cqu_logo.png}}
        \subfigure[]{\includegraphics[width=0.47\textwidth]{cqubackground.png}}
